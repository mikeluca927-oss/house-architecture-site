  ...
  return (
    <SEOLandingPage
      ...
      paragraphs={[
        ...
        "Our Westchester County service area encompasses the full county — from Yonkers and the urban edge of the Bronx to the northern reaches of the county near Putnam County. We have active and completed projects in Eastchester, Scarsdale, Bronxville, Larchmont, White Plains, Yonkers, Pelham, New Rochelle, Tarrytown, Ossining, and beyond. Our deep familiarity with Westchester's varied municipalities means we understand the specific requirements of each jurisdiction.",
