...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.housearchitecturepllc.com/westchester-renovation-contractor',
  },
  alternates: {
    canonical: 'https://www.housearchitecturepllc.com/westchester-renovation-contractor',
  },
}
  ...
  return (
    <SEOLandingPage
      ...
      paragraphs={[
        ...
        "We have completed renovation projects across Westchester County's diverse communities — from updating split-level homes in Yonkers to performing whole-home renovations in Scarsdale, restoring historic Colonials in Larchmont, and modernizing post-war homes in White Plains. Each project received the same personal attention from Silvio Luca and the same commitment to craftsmanship from our construction team.",
