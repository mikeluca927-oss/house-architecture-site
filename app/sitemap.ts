...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/scarsdale-contractor`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE}/eastchester-contractor`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${SITE}/westchester-contractor-architecture`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
